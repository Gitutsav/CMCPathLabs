...
public class MainActivity extends AppCompatActivity {
    ...
    EditText pname, age, gender, address;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        age= (EditText) findViewById(R.id.mob);
        gender= (EditText) findViewById(R.id.email);
        address= (EditText) findViewById(R.id.linkedin);
    ...
    * */
    private void addArtist() {
        ...
        String mob= age.getText().toString().trim();
        ...
        if (!TextUtils.isEmpty(name)) {
            ...
            Artist artist = new Artist(id, name, mob,gend,add,genre, "", "", "");
